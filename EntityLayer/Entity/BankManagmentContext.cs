...
{
    public partial class BankManagmentContext : DbContext
    {
        public BankManagmentContext()
        {
        }

        public BankManagmentContext(DbContextOptions<BankManagmentContext> options)
            : base(options)
        {
        }

        public virtual DbSet<Accounts.Accounts> Accounts { get; set; }
        ...
        public virtual DbSet<Credits.Credits> Credits { get; set; }
        public virtual DbSet<Departaments.Departaments> Departaments { get; set; }
        ...
        public virtual DbSet<Persons.Persons> Persons { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=BesarKutleshi;Database=BankManagment;Trusted_Connection=True;");
            }
        }

        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Accounts.Accounts>(entity =>
            {
            ...
            modelBuilder.Entity<Credits.Credits>(entity =>
            {
            ...
            modelBuilder.Entity<Departaments.Departaments>(entity =>
            {
                entity.Property(e => e.Id).HasColumnName("ID");
            ...
            modelBuilder.Entity<Persons.Persons>(entity =>
            {
                entity.Property(e => e.Id).HasColumnName("ID");
